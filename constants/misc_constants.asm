...
; start menu
START_MENU_DEX EQU 0
START_MENU_PKMN EQU 1
START_MENU_PACK EQU 2
START_MENU_MAP EQU 3
START_MENU_STATUS EQU 4
START_MENU_SAVE EQU 5
START_MENU_OPTION EQU 6
START_MENU_EXIT EQU 7
START_MENU_TREASURE_BAG EQU 8
...
BTMON_STRUCT_LENGTH EQUS "wBT_OTPkmn1StatsEnd - wBT_OTPkmn1"
